...
export const courses: CourseLevel[] = [
  {
    ...
    included: [
      ...
      { icon: '📜', title: 'Certificate', description: 'Completion certificate' },
    ],
    theme: levelThemes[1],
  },
  {
  ...
  },
  {
    ...
    sessions: [
      ...
      },
      {
        ...
        activity: 'Each student designs, prints, and presents an AI-generated project; peer feedback session',
      },
      {
        id: 4,
        title: 'Advanced Workshop (Optional)',
        learningPoints: [
          'Multi-material printing concepts',
          'Post-processing techniques',
          'Industry applications of AI + 3D printing',
        ],
        activity: 'Collaborative group project using advanced techniques learned throughout the course',
        isOptional: true,
      },
    ],
    requirements: [
    ...
    included: [
      ...
      { icon: '🏆', title: 'Certificate', description: 'Advanced certification' },
    ],
    theme: levelThemes[3],
  },
];
